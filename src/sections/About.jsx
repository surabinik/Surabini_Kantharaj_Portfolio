          ...
          <div className="about-card">
            ...
            <div className="about-info-list">
              <div className="about-info-item">
                ...
                <span className="about-info-value">[YOUR DEGREE / PROGRAM]</span>
              </div>

              <div className="about-info-item">
                <span className="about-info-label">University</span>
                <span className="about-info-value">[YOUR UNIVERSITY NAME]</span>
              </div>

              <div className="about-info-item">
                <span className="about-info-label">Location</span>
                <span className="about-info-value">[YOUR CITY / COUNTRY]</span>
              </div>

              <div className="about-info-item">
                <span className="about-info-label">Email</span>
                <span className="about-info-value">[YOUR EMAIL]</span>
              </div>

              <div className="about-info-item">
                <span className="about-info-label">Interests</span>
                <span className="about-info-value">Web Apps, OOP, Database Systems, AI</span>
              </div>
            </div>
          </div>
        </div>
